...
{
    /// <summary>Colbur Berry: halves a super-effective Dark-type hit, then is consumed.</summary>
    public sealed class ColburberryEffect : Effect
    {
        public override string EffectId => "colburberry";
        public override string DisplayName => "Colbur Berry";
        public override void OnModifyDamage(ModifyDamageEvent ev, Pokemon owner)
        {
            ...
            ev.Battle.ConsumeItem(owner, "item: Colbur Berry");
        }
    }
}
