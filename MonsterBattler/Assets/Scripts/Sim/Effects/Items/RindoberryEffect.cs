...
{
    /// <summary>Rindo Berry: halves a super-effective Grass-type hit, then is consumed.</summary>
    public sealed class RindoberryEffect : Effect
    {
        public override string EffectId => "rindoberry";
        public override string DisplayName => "Rindo Berry";
        public override void OnModifyDamage(ModifyDamageEvent ev, Pokemon owner)
        {
            ...
            if (ev.Move.Type != MonType.Grass) return;
            ...
            ev.Battle.ConsumeItem(owner, "item: Rindo Berry");
        }
    }
}
