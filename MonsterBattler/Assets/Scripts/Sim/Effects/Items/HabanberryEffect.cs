...
{
    /// <summary>Haban Berry: halves a super-effective Dragon-type hit, then is consumed.</summary>
    public sealed class HabanberryEffect : Effect
    {
        public override string EffectId => "habanberry";
        public override string DisplayName => "Haban Berry";
        public override void OnModifyDamage(ModifyDamageEvent ev, Pokemon owner)
        {
            ...
            ev.Battle.ConsumeItem(owner, "item: Haban Berry");
        }
    }
}
