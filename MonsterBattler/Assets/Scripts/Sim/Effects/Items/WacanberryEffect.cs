...
{
    /// <summary>Wacan Berry: halves a super-effective Electric-type hit, then is consumed.</summary>
    public sealed class WacanberryEffect : Effect
    {
        public override string EffectId => "wacanberry";
        public override string DisplayName => "Wacan Berry";
        public override void OnModifyDamage(ModifyDamageEvent ev, Pokemon owner)
        {
            ...
            ev.Battle.ConsumeItem(owner, "item: Wacan Berry");
        }
    }
}
